// Virtual Tour 3D View - Module version with proper Three.js imports
...
function initVirtualTour() {
    ...
    tourRenderer.shadowMap.enabled = true;
    tourRenderer.shadowMap.type = THREE.PCFSoftShadowMap;
    ...
    if (galleryEl) {
        ...
        if (media.length === 0) {
            ...
            media.forEach(item => {
                ...
                mediaItem.onclick = () => showMediaInTour(item);
                mediaItem.innerHTML = `
...
window.enterVirtualTourWithMedia = enterVirtualTourWithMedia;
window.exitVirtualTour = exitVirtualTour;
window.toggleTourFullscreen = toggleTourFullscreen;
window.showMediaInTour = showMediaInTour;
